...
class FourierSeries:
    ...
    def text(
        ...
        font : str
            ...
            is highly recommended for multiple letters. Try [Brush Script MT](https://github.com/taibeled/manim-fourier-series/raw/refs/heads/master/examples/fonts/brush.ttf) or similar.
